...
int YabauseInit(yabauseinit_struct *init)
{
   ...
   {
      YabSetError(YAB_ERR_CANNOTINIT, _("SCSP"));
      return -1;
   }
#endif
...
#else
      yabsys.DecilineMode ? yabsys.DecilineStop * 10 / declinenum : yabsys.DecilineStop * 10;
#endif
   const u32 usecinc =
#ifndef GEKKO
      yabsys.DecilineMode ? yabsys.DecilineUsec : yabsys.DecilineUsec * 10;
#else
      yabsys.DecilineMode ? yabsys.DecilineUsec * 10 / declinenum : yabsys.DecilineUsec * 10;
#endif
#ifndef SCSP_PLUGIN
#ifndef USE_SCSP2
